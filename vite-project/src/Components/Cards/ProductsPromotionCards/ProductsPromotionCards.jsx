        ...
        <div className='products-promotion-cards_container'>
            <div className="products-promotion-cards_content">
                ...
                <div className="products-promotion-cards_info">
                    <div className="products-promotion-cards_info_has"><span className='cards_info_has_text'>В наличии</span>
                        <span className='circle_has_info'></span>
                        <span className='circle_has_info'></span>
                        <span className='circle_has_info'></span>
                        <span className='in_the_showroom_has_info'>Есть в шоу-руме</span>
                    </div>
                    <div className="products-promotion-cards_info_title">{titleCard}</div>
                    <div className="products-promotion-cards_info_rating">Рейтинг<span className='products-promotion-cards_info_stars'>★★★★★</span></div>
